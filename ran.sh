...
function init() {
	...
	*) echo "init: unknown mep node $nodemep" ;;
    ...
    echo "ip route replace 192.168.80.2 via 192.168.3.$suffix_mep"
    ip route replace 192.168.80.2 via 192.168.3."$suffix_mep"
    echo "ip route replace 192.168.80.4 via 192.168.3.$suffix_mep"
    ip route replace 192.168.80.4 via 192.168.3."$suffix_mep"
    echo "ip route replace 192.168.80.5 via 192.168.3.$suffix_mep"
    ip route replace 192.168.80.5 via 192.168.3."$suffix_mep"
    echo "ip route replace 192.168.80.169 via 192.168.3.$suffix_mep"
    ip route replace 192.168.80.169 via 192.168.3."$suffix_mep"
}
